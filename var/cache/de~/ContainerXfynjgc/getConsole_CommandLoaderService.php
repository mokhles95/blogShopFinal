...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('JMS\\Payment\\CoreBundle\\Command\\GenerateKeyCommand' => function () {
    $f = function (\JMS\Payment\CoreBundle\Command\GenerateKeyCommand $v) { return $v; }; return $f(${($_ = isset($this->services['JMS\Payment\CoreBundle\Command\GenerateKeyCommand']) ? $this->services['JMS\Payment\CoreBundle\Command\GenerateKeyCommand'] : $this->load('getGenerateKeyCommandService.php')) && false ?: '_'});
